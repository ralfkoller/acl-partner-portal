    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-acl-dark relative overflow-hidden flex-col items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center">
          <Image src="/acl-logo.png" alt="ACL Logo" width={80} height={80} className="mx-auto mb-8" priority />
        ...
        <div className="absolute bottom-8 text-white/30 text-sm">ACL advanced commerce labs GmbH</div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center gap-3 mb-10">
            <Image src="/acl-logo.png" alt="ACL Logo" width={40} height={40} />
          ...
          <form action={handleLogin} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-medium text-acl-dark">E-Mail-Adresse</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-sm font-medium text-acl-dark">Passwort</Label>
              <div className="relative">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="remember" className="text-sm text-acl-gray cursor-pointer">Angemeldet bleiben</Label>
              </div>
              <span className="text-sm text-acl-gray">
